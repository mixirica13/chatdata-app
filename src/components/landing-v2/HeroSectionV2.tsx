      ...
      <div className="relative z-10 container mx-auto px-6 py-20">
        ...
        <div className="flex justify-center mb-8 animate-fade-in-up">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-xl">
            ...
            <span className="text-sm text-white/90 font-medium">Seu Analista de IA disponível 24/7</span>
          </div>
        </div>
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight text-center animate-fade-in-up" style={{ fontFamily: 'Exo 2, sans-serif' }}>
          Converse com seus Dados do
          <br />
          <span className="bg-gradient-to-r from-[#46CCC6] to-[#2D9B96] bg-clip-text text-transparent">
            Meta Ads como nunca antes
          </span>
        </h1>

        {/* Subheadline */}
        <p className="text-lg md:text-xl text-white/70 max-w-3xl mx-auto mb-12 text-center leading-relaxed animate-fade-in-up">
          Um Agente de IA que conhece suas campanhas a fundo e responde suas perguntas em tempo real.
          <br className="hidden md:block" />
          Insights inteligentes direto no WhatsApp, quando você precisar.
        </p>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 hover:border-[#46CCC6]/30 transition-all">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {/* Left: Conversa */}
                <div className="aspect-square bg-gradient-to-br from-white/10 to-transparent rounded-2xl flex flex-col items-center justify-center p-8">
                  <MessageCircle className="w-16 h-16 text-[#46CCC6] mb-4" />
                  <p className="text-white/70 text-center font-semibold mb-2">Conversa com a IA</p>
                  <p className="text-white/50 text-sm text-center">
                    "Quais campanhas tiveram melhor ROI esta semana?"
                  </p>
                  <div className="mt-4 w-full max-w-xs">
                    <div className="bg-[#46CCC6]/10 border border-[#46CCC6]/20 rounded-xl p-3">
                      <p className="text-[#46CCC6] text-xs">💡 IA está digitando...</p>
                    </div>
                  </div>
                </div>
                ...
                {/* Right: Dashboard */}
                <div className="aspect-square bg-gradient-to-br from-white/10 to-transparent rounded-2xl flex flex-col items-center justify-center p-8">
                  <Sparkles className="w-16 h-16 text-[#46CCC6] mb-4" />
                  <p className="text-white/70 text-center font-semibold mb-2">Dashboard Completo</p>
                  <p className="text-white/50 text-sm text-center">
        ...
        <div className="grid grid-cols-3 gap-4 max-w-2xl mx-auto mt-12 animate-fade-in-up">
          <div className="text-center">
            ...
            <p className="text-white/60 text-xs md:text-sm">Disponibilidade</p>
          </div>
          <div className="text-center">
            <div className="text-2xl md:text-3xl font-bold text-[#46CCC6] mb-1" style={{ fontFamily: 'Exo 2, sans-serif' }}>
              Instant
            </div>
            <p className="text-white/60 text-xs md:text-sm">Respostas</p>
          </div>
          <div className="text-center">
            <div className="text-2xl md:text-3xl font-bold text-[#46CCC6] mb-1" style={{ fontFamily: 'Exo 2, sans-serif' }}>
              100%
            </div>
            <p className="text-white/60 text-xs md:text-sm">Personalizado</p>
          </div>
        </div>
      </div>
    </section>
